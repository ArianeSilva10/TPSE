...
typedef enum{
   ...
   CM_efuse_sma                  = 0x07FC,
   CM_conf_gpmc_ad0              = 0x0800,//pino 0
   CM_conf_gpmc_ad1              = 0x0804, // pino 1
   CM_conf_gpmc_ad2              = 0x0808, // pino 2
   CM_conf_gpmc_ad3              = 0x080C, // pino 3
   CM_conf_gpmc_ad4              = 0x0810, // pino 4
   CM_conf_gpmc_ad5              = 0x0814, // pino 5
   CM_conf_gpmc_ad6              = 0x0818, // pino 6
   CM_conf_gpmc_ad7              = 0x081C,// pino 7
   CM_conf_gpmc_ad8              = 0x0820,
   CM_conf_gpmc_ad9              = 0x0824,
   CM_conf_gpmc_ad10             = 0x0828,
   CM_conf_gpmc_ad11             = 0x082C,
   CM_conf_gpmc_ad12             = 0x0830, // pino 12
   CM_conf_gpmc_ad13             = 0x0834, // pino 13
   CM_conf_gpmc_ad14             = 0x0838, // pino 14
   CM_conf_gpmc_ad15             = 0x083C, // pino 15
   CM_conf_gpmc_a0               = 0x0840, // pino 16
   CM_conf_gpmc_a1               = 0x0844, // pino 17
   CM_conf_gpmc_a2               = 0x0848, // pino 18
   CM_conf_gpmc_a3               = 0x084C, // pino 19
   CM_conf_gpmc_a4               = 0x0850, // pino 20
   CM_conf_gpmc_a5               = 0x0854, // pino 21
   CM_conf_gpmc_a6               = 0x0858, // pino 22
   CM_conf_gpmc_a7               = 0x085C, // pino 23
   CM_conf_gpmc_a8               = 0x0860, // pino 24
   CM_conf_gpmc_a9               = 0x0864, // pino 25
   CM_conf_gpmc_a10              = 0x0868, // pino 26
   CM_conf_gpmc_a11              = 0x086C, // pino 27
   CM_conf_gpmc_wait0            = 0x0870,
   CM_conf_gpmc_wpn              = 0x0874,
   CM_conf_gpmc_ben1             = 0x0878, // pino 28
   CM_conf_gpmc_csn0             = 0x087C, // pino 29
   CM_conf_gpmc_csn1             = 0x0880, // pino 30
   CM_conf_gpmc_csn2             = 0x0884, // pino 31
   ...
   CM_conf_uart0_rtsn            = 0x096C, // pino 9
   CM_conf_uart0_rxd             = 0x0970, // pino 10
   CM_conf_uart0_txd             = 0x0974, // pino 11
   CM_conf_uart1_ctsn            = 0x0978, // pino 8
   ...
   CM_conf_usb1_drvvbus          = 0x0A34, //pino 13, gpio3
