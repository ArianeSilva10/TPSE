...
#define CM_PER_GPIO2_CLKCTRL_OPTFCLKEN_GPIO_2_GDBCLK   			(0x00040000u) // Valor para habilitar o clock, bit 18 setado em 1
#define CM_PER_GPIO2											(0xB0u) // Endereço do registrador de controle do modulo de clock para GPIO1
#define CM_PER_GPIO2_CLKCTRL_MODULEMODE_ENABLE   				(0x2u) // Valor pra habilitar o modulo do clock do GPIO1
...
#define conf_gpmc_clk											0x088C // gpio2_1											
...
void ledInit( ){
	...
	HWREG(SOC_CONTROL_REGS+conf_gpmc_clk) |= 7;
	/*-----------------------------------------------------------------------------
