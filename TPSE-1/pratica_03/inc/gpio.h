 ...
 *-----------------------------------------------------------------------------*/
typedef unsigned int ucPinNumber;
...
void Init_pin_gpio(gpioMod , unsigned int pin , Direction);
void Set_direction_pin_gpio(gpioMod, unsigned int pin, Direction);
unsigned int Get_direction_pin_gpio(gpioMod , unsigned int pin);
